...
from school.views import student_list, student_create, student_update, grade_list,grade_create, grade_update, SubjectView, SubjectCreateView, SubjectUpdateView
